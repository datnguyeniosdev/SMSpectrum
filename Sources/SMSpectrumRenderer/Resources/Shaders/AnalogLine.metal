...
struct VertexOut {
    ...
    float  side;       // -1 or +1, distance from line center
...
vertex VertexOut analogLineVertex(uint vertexID [[vertex_id]],
...
fragment float4 analogLineFragment(VertexOut in [[stage_in]],
